...
public class BeautyProductResource {
    ...
    @GET
    public List<BeautyProduct> getPersons(@QueryParam("id") String id,
        ...
        List<BeautyProduct> beautyProducts = new PostgreSQLDAO(getConnection()).findBeautyProduct(id, name, producingCountry, vendorCode, category, price);
        return beautyProducts;
    }
