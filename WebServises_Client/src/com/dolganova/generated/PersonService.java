 ...
 * 
 */
@WebServiceClient(name = "PersonService", targetNamespace = "http://lab1.dolganova.com/", wsdlLocation = "http://localhost:8081/PersonService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PERSONSERVICE_QNAME = new QName("http://lab1.dolganova.com/", "PersonService");
    ...
    public PersonWebService getPersonWebServicePort() {
        return super.getPort(new QName("http://lab1.dolganova.com/", "PersonWebServicePort"), PersonWebService.class);
    }
    ...
    public PersonWebService getPersonWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://lab1.dolganova.com/", "PersonWebServicePort"), PersonWebService.class, features);
    }
